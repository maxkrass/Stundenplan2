...
public class RevealLayout extends FrameLayout{
    ...
    public void show(int x, int y, int duration, @Nullable final Animation.AnimationListener listener) {
        ...
        //final int startColor = getResources().getColor(R.color.material_red);
        //int endColor = getResources().getColor(R.color.material_light_green);
        //final int deltaColor = endColor - startColor;
        ...
        mAnimation = new Animation() {
            ...
            protected void applyTransformation(float interpolatedTime, Transformation t) {
                ...
                //setBackgroundColor((int) (startColor + interpolatedTime * deltaColor));
            }
        };
